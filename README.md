...
| ami_name_prefix            | string | localstack                       | Prefix used for the name tags of resulting AMIs. The version will be appended to this.                                                                    |
...
| aws_source_ami_filter_name | string | al2023-ami-2023.\*-x86_64        | Source AMI filter string as per the DescribeImages API documentation. If multiple match, the latest image will be used.                                   |
...
| configuration_group        | string | localstack                       | The name of the group to which to add the instance for configuration purposes                                                                             |
